package net.Teepi_.mccourse;

import com.mojang.logging.LogUtils;
import net.Teepi_.mccourse.block.ModBlocks;
import net.Teepi_.mccourse.enchantment.ModEnchantments;
import net.Teepi_.mccourse.item.ModCreativeModeTabs;
import net.Teepi_.mccourse.item.ModItemProperties;
